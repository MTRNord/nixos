  ...
  services.github-runners = {
    "node-yara-rs" = {
      ...
      extraEnvironment = {
        ...
        BINDGEN_EXTRA_CLANG_ARGS = "$(< ${pkgs.clang_16}/nix-support/cc-cflags) $(< ${pkgs.clang_16}/nix-support/libc-cflags) $(< ${pkgs.clang_16}/nix-support/libcxx-cxxflags) $NIX_CFLAGS_COMPILE -idirafter ${pkgs.clang_16}/lib/clang/${lib.getVersion pkgs.clang_16}/include";
      };
    };
  };
}
